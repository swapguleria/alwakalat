...
<?php if (isset($_SESSION['success'])) { ?>
                            <div style="color: red;
                                 font-size: 15px;
                                 padding: 5px;"><?php echo $_SESSION['success'];
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <input type="text" id="title" name="review_title" value="<?php if (isset($results['review_title'])) {
                echo $results['review_title'];
            } ?>" class="form-control" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <input type="text" id="title" name="review_title_arabic" value="<?php if (isset($results['review_title_arabic'])) {
                echo $results['review_title_arabic'];
            } ?>" class="form-control" >
                                            </div>
                                        </div>
                                    </div>	
                                    ...
                                    <div class="form-group">                           
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <textarea name="content" id="ckeditor"><?php if (isset($results['content'])) {
                echo $results['content'];
                                    ...
                                    <div class="form-group">                           
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <textarea name="content_arabic" id="ckeditor2"><?php if (isset($results['content_arabic'])) {
                echo $results['content_arabic'];
            } ?></textarea>		
                                        </div>                        
                                    </div>												
...
<!-- Load and execute Java Script code used only in this page -->
