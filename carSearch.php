                        ...
                        <div class="form-group">						
                            <form action="" method="get">
                                ...
                                <select name="order" onchange="javascript: submit()">
                                    <option value="id" <?php echo ($_GET['order'] == 'id') ? 'selected="Selected"' : ''; ?>>Latest</option>
...
//                                              <----------  get the year of worranty Start------------->
                                            ...
                                            <div class="car_text_2">
                                                <p>HorsePower</p>
                                                <span class="pull-right"><?php echo (@$val['horse_power'] != '0') ? $val['horse_power']." HP" : "N/A"; ?></span>
                                            </div>    
                                        </div>	
                                    </div>	
                                </div>
                            ...
                            ?> <div class="col-md-12">
                                <div class="col-sm-4 col-sm-offset-4">
                                    <div class="more_list_item">
                                        <a href="javascript:void(0)" id="ViewMoreListItema">Load More</a>
                                    </div>
                                </div>
                            </div><?php
                        } else {
