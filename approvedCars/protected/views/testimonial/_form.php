...
<div class="form">
    ...
    <?php
    echo $form->textAreaGroup($model, 'text', array('class' => 'form-control', 'rows' => 5));
    ;
    ?>
    <?php echo $form->textFieldGroup($model, 'city', array('class' => 'form-control', 'maxlength' => 255)); ?>
<?php echo $form->textFieldGroup($model, 'state', array('class' => 'form-control', 'maxlength' => 255)); ?>


<?php // echo $form->dropDownListGroup($model, 'state', array('widgetOptions' => array('data' => $model->getStatusOptions(), 'htmlOptions' => array('class' => 'input-large'))));   ?>
