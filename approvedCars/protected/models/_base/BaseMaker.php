...
/**
 * This is the model base class for the table "{{maker}}".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "Maker".
 *
 * Columns in table "{{maker}}" available as properties of the model,
 ...
 *
 */
abstract class BaseMaker extends GxActiveRecord
    {
    ...
    public static function label($n = 1)
        {
        return Yii::t('app', 'Maker|Makers', $n);
        }
    ...
    public function relations()
        {
        return array(
            'carModels' => array(self::HAS_MANY, 'carModel', 'model_id'),
