...
//        {
//        return Yii::t('app', 'Used Car|Used Cars', $n);
//        }
//
...
//        {
//        return array(
//            array('maker_id, model_id, body_type_id, year, service_package, kilometer, price, dealer_id', 'required'),
//            array('maker_id, model_id, body_type_id, year, service_package, gear_type, exterior_color, interior_color, fuel_type, owners, transmission, kilometer, price, dealer_id, create_user_id', 'numerical', 'integerOnly' => true),
//            array('milage', 'numerical'),
//            array('accident, warranty, roof, camera, GPS, type_id, state_id', 'length', 'max' => 1),
//            array('accident_desc, warranty_expire_date, create_time', 'safe'),
...
//            'body_type_id' => Yii::t('app', 'Body Type'),
//            'year' => Yii::t('app', 'Year'),
