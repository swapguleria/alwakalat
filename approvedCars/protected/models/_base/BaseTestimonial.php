...
//	}	
	...
	public function rules() {
		return array(
			array('name, image, text, city, state, create_time', 'required'),
			array('state_id, type_id', 'numerical', 'integerOnly'=>true),
			array('name, image, city, state', 'length', 'max'=>255),
			array('state_id, type_id', 'default', 'setOnEmpty' => true, 'value' => null),
			array('id, name, image, text, city, state, state_id, type_id, create_time', 'safe', 'on'=>'search'),
		);
	}
