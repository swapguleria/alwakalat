...
abstract class BaseUser extends GxActiveRecord
    ...
    public static function label($n = 1)
        {
        return Yii::t('app', 'Dealer|Dealers', $n);
        }
    ...
    public function rules()
        ...
        return array(
            ...
            array(
                'first_name,email,username, password,title,makers,company_name,family_name,address,phone_no',
                'required'
            ),
            array(
                'work_in_abroad, salary, martial_status, zip_code, currency_type, tos, role_id, state_id, login_error_count, employer_id, create_user_id,phone_no',
                'numerical',
                'integerOnly' => true
            ),
            array(
            ...
            array(
                'first_name, last_name, language, nationality,username, employment, religion, address, city, country, lat, long,title,makers,company_name,family_name,company_profile,website,title,mobile_no',
                'length',
                'max' => 256
            ),
            array(
            ...
            array(
                'about_me, last_visit_time, create_time,is_notification,date_of_birth,title,mobile_no,makers,website,company_name,company_profile,family_name',
                'safe'
            ),
            array(
            ...
            array(
                'id,title,mobile_no,makers,website,company_name,company_profile,family_name, first_name, last_name, email, password, phone_no, language, nationality, date_of_birth, work_in_abroad, salary, martial_status, employment, experience, religion, address, city, country, zip_code, currency_type, timezone, about_me, image_file, lat, long, tos, role_id, state_id, last_visit_time, activation_key, login_error_count, employer_id, create_user_id, create_time,username',
                'safe',
                'on' => 'search'
            )
        );
