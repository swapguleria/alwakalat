...
class TestimonialController extends GxController
    {
    ...
    public function actionUpdate($id)
        ...
        if (isset($_POST['Testimonial']))
            {
            $model->setAttributes($_POST['Testimonial']);
            $new_image = $model->saveUploadedFile($model, 'image');
            if (!$new_image)
                {
    ...
    public function actionAdmin()
        ...
        if (isset($_GET['Testimonial'])) $model->setAttributes($_GET['Testimonial']);
    ...
    protected function updateMenuItems($model = null)
        ...
        if ($model == null) $model = new Testimonial();
