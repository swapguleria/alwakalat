...
class MakerController extends GxController
    {
    ...
    public function accessRules()
        ...
        return array(
            ...
            array('allow',
                'actions' => array('create', 'admin', 'adminDealer', 'delete', 'update', 'search'),
                'users' => array('@'),
            ),
//				array('allow', 
...
//					),
    ...
    public function actionCreate()
        ...
        $this->performAjaxValidation($model, 'maker-form');

        if (isset($_POST['Maker']))
            {
            $model->setAttributes($_POST['Maker']);
    ...
    public function actionDelete($id)
        ...
        if (Yii::app()->getRequest()->getIsPostRequest())
            {
            $this->loadModel($id, 'Maker')->delete();
    ...
    public function actionIndex()
        ...
        $dataProvider = new CActiveDataProvider('Maker');
    ...
    public function actionSearch()
        ...
        if (isset($_GET['Maker']))
            {
            $model->setAttributes($_GET['Maker']);
    ...
    public function actionAdmin()
        {
        $model = new Maker('search');
        $model->unsetAttributes();
        $this->updateMenuItems($model);

        if (isset($_GET['Maker'])) $model->setAttributes($_GET['Maker']);
