...
class SubModelController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'SubModel');
	...
	public function actionCreate() 
	{
		...
		$this->performAjaxValidation($model, 'sub-model-form');

		if (isset($_POST['SubModel'])) {
			$model->setAttributes($_POST['SubModel']);
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'SubModel')->delete();
	...
	public function actionIndex() 
	{
		...
		$dataProvider = new CActiveDataProvider('SubModel');
	...
	public function actionSearch()
	{
		...
		{
			$model->setAttributes($_GET['SubModel']);
	...
	{	
		...
		if ( $model == null ) $model = new SubModel();
