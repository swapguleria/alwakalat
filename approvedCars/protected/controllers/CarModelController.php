...
class CarModelController extends GxController
    {
    ...
    public function accessRules()
        ...
        return array(
            array('allow',
                'actions' => array('index', 'view', 'adminDealer', 'getModel', 'getSubModel' /* 'download', 'thumbnail' */),
                'users' => array('*'),
            ),
            array('allow',
    ...
    public function actionView($id)
        {
        $model = $this->loadModel($id, 'CarModel');
...
//        $this->layout = '//layouts/column1';
        ...
        $this->performAjaxValidation($model, 'car-model-form');

        if (isset($_POST['CarModel']))
            {
            $model->setAttributes($_POST['CarModel']);
    ...
    public function actionDelete($id)
        ...
        if (Yii::app()->getRequest()->getIsPostRequest())
            {
            $this->loadModel($id, 'CarModel')->delete();
    ...
    public function actionGetModel()
        {
        $maker_id = $_POST['id'];
        $result = CarModel::model()->findAllByAttributes(array('maker_id' => $maker_id));
    ...
    public function actionGetSubModel()
        {
        $maker_id = $_POST['id'];
        $result = SubModel::model()->findAllByAttributes(array('model_id' => $maker_id));
//        print_r($result);
//        die();
    ...
    public function actionSearch()
        ...
        if (isset($_GET['CarModel']))
            {
            $model->setAttributes($_GET['CarModel']);
    ...
    public function actionAdmin()
        ...
        if (isset($_GET['CarModel'])) $model->setAttributes($_GET['CarModel']);
    ...
    protected function updateMenuItems($model = null)
        ...
        if ($model == null) $model = new CarModel();
