        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                if (Yii::app()->user->isAdmin)
                    ...
                    ?>
                    <a class="logo"
                       href="<?php echo Yii::app()->createUrl('dashboard/index') ?>"><b>Alwakalat </b> </a>
                       <?php
                       }
                   else
                       {
                       ?>
                    <a class="logo"
                       href="<?php echo Yii::app()->createUrl('site/index') ?>"><b>Alwakalat </b> </a>
                   <?php } ?>
                ...
                <section class="sidebar" style="height: auto;">
                    <ul class="sidebar-menu">
                        ...
                        if (Yii::app()->user->isAdmin)
                            {
                            ?>
                            <li class="<?php echo ($this->id == 'dashboard' and $this->action->id == 'index') ? 'active' : '' ?>">
                            ...
                            <li class="<?php echo ($this->id == 'user' and $this->action->id == 'admin') ? 'active' : '' ?>">
                                <a href="<?php echo Yii::app()->createURL('user/admin') ?>" >
                                    <i class="fa fa-user"></i><span> Dealers</span></a>
                            </li>
                            <li class="treeview"> 
                                <a href="#"><i class="fa fa-edit"></i> <span>Manage</span>
                                    <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                                <ul class="treeview-menu"> 
                                    <li class="<?php echo ($this->id == 'maker' and $this->action->id == 'admin') ? 'active' : '' ?>">
                                        <a href="<?php echo Yii::app()->createURL('maker/admin') ?>" >
                                            <i class="fa fa-user"></i><span> Makers </span></a>
                                    </li>
                                    <li class="<?php echo ($this->id == 'model' and $this->action->id == 'admin') ? 'active' : '' ?>">
                                        <a href="<?php echo Yii::app()->createURL('carModel/admin') ?>" >
                                            <i class="fa fa-user"></i><span> Models </span></a>
                                    </li>
                                    <li class="<?php echo ($this->id == 'bodyType' and $this->action->id == 'admin') ? 'active' : '' ?>">
                                        <a href="<?php echo Yii::app()->createURL('bodyType/admin') ?>" >
                                            <i class="fa fa-user"></i><span> Body Type </span></a>
                                    </li> 
                                    <li class="<?php echo ($this->id == 'subModel' and $this->action->id == 'admin') ? 'active' : '' ?>">
                                        <a href="<?php echo Yii::app()->createURL('subModel/admin') ?>" >
                                            <i class="fa fa-user"></i><span> Sub Model </span></a>
                                    </li>   
                                </ul>
                            </li>  
                            <li class="<?php echo ($this->id == 'usedCar' and $this->action->id == 'create') ? 'active' : '' ?>">
                                <a href="<?php echo Yii::app()->createURL('usedCar/create') ?>" >
                                    <i class="fa fa-user"></i><span>Add Cars</span></a>
                            </li>
                            <li class="<?php echo ($this->id == 'usedCar' and $this->action->id == 'admin') ? 'active' : '' ?>">
                                <a href="<?php echo Yii::app()->createURL('usedCar/admin') ?>" >
                                    <i class="fa fa-user"></i><span> Approved Car</span></a>
                            </li>
                            <li class="<?php echo ($this->id == 'usedCar' and $this->action->id == 'adminApproval') ? 'active' : '' ?>">
                                <a href="<?php echo Yii::app()->createURL('usedCar/adminApproval') ?>" >
                                    <i class="fa fa-user"></i><span> Approval Requests</span></a>
                            </li>
                            <li class="<?php echo ($this->id == 'usedCar' and $this->action->id == 'adminSold') ? 'active' : '' ?>">
                                <a href="<?php echo Yii::app()->createURL('usedCar/adminSold') ?>" >
                                    <i class="fa fa-user"></i><span> Sold Cars</span></a>
                            </li>
                            <li class="<?php echo ($this->id == 'testimonial' and $this->action->id == 'admin') ? 'active' : '' ?>">
                            ...
                            <li class="<?php echo ($this->id == 'usedCar' and $this->action->id == 'create') ? 'active' : '' ?>">
                                <a href="<?php echo Yii::app()->createURL('usedCar/create') ?>" >
                                    <i class="fa fa-user"></i><span>Add Old Cars</span></a>
                            </li>
                            <li class="<?php echo ($this->id == 'usedCar' and $this->action->id == 'adminDealer') ? 'active' : '' ?>">
                                <a href="<?php echo Yii::app()->createURL('usedCar/adminDealer') ?>" >
                                    <i class="fa fa-user"></i><span> Un Approved Cars </span></a>
                            </li>
                            <li class="<?php echo ($this->id == 'usedCar' and $this->action->id == 'dealerApproved') ? 'active' : '' ?>">
                                <a href="<?php echo Yii::app()->createURL('usedCar/dealerApproved') ?>" >
                                    <i class="fa fa-user"></i><span> Approved Cars</span></a>
                            </li>
                            <li class="<?php echo ($this->id == 'usedCar' and $this->action->id == 'dealerSold') ? 'active' : '' ?>">
                                <a href="<?php echo Yii::app()->createURL('usedCar/dealerSold') ?>" >
                                    <i class="fa fa-user"></i><span> Sold Cars</span></a>
                            </li>
                        <?php } ?>
                    </ul>
