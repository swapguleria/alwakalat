							...
							<div id="myCarousel" class="carousel slide" data-ride="carousel">
								  ...
								  <div class="carousel-inner" role="listbox">
									<div class="item active">
									  <img src="slider/Mercedes E 300 Side2.jpg" alt="">
									</div>
									...
									<div class="item">
									  <img src="slider/slider5.jpg" alt="">
									</div>
								...
								<tbody>
								  <tr class="productRow">
									<td>
										<div class="title">
											<div class="main_logo text-left">
												...
												<div>QNB Vehicle Loan for Qatari Nationals</div>
											</div>
										</div>
									</td>
									<td>QAR 6,000 </td>
									...
									<td>
										...
										<a href="#" class="td_compare_btn">Compare</a>
										</div>
									</td>
								  </tr>
								  <tr class="viewMoreDetailsRow">
									<td colspan="100">
								  ...
								  <tr class="viewMoreDetailsRow">
									<td colspan="100">
										<a href="#demo_2" class="more_detail" data-toggle="collapse">View More Details</a>
										<div class="drop_content">
								  ...
								  <tr class="viewMoreDetailsRow">
									<td colspan="100">
										<a href="#demo_3" class="more_detail" data-toggle="collapse">View More Details</a>
										<div class="drop_content">
