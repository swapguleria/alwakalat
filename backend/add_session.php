        ...
        <div class="col-md-9">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    ...
                    <h2><strong>Add Session Page</strong></h2>
				...
				<input type="hidden" name="action" value="Insert_session">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="session_name" name="session_name" class="form-control" placeholder="Session Name..">
