                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input type="text" id="find_name" name="find_name" class="form-control" placeholder="Find Name..">
