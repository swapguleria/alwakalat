<?php include 'inc/config.php'; $template['sidebar'] = 'sidebar-no-animations'; ?>
...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-show_big_thumbnails"></i>No Sidebars<br><small>Can be set as the default on all layouts! (> 991px)</small>
            </h1>
        </div>
    </div>
