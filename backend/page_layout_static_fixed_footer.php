<?php include 'inc/config.php'; $template['footer'] = 'footer-fixed'; ?>
...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-show_big_thumbnails"></i>Static + Fixed Footer<br><small>You can have a fixed footer on all layouts</small>
            </h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li>Page Layouts</li>
        <li><a href="">Static + Fixed Footer</a></li>
    </ul>
    <!-- END Static + Fixed Footer Header -->
