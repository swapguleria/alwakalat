...
class model{
	...
	function add_car_event(){
	   ...
	   $allowed_filetypes = array('jpg','gif','bmp','png'); 
		...
		$update		=	"UPDATE `events` set image = '".$slider_name."', thumb ='".$thumb_path."', full_path ='".$full_path."',event_title='".$event_title."', title_arabic ='".$ar_title."', event_location='".$event_location."',location_arabic = '".$ar_location."', event_description='".$event_desc."' , desc_arabic='".$ar_desc."',test_drive='".$test_drive."',drive_arabic='".$ar_drive."',event_start_date='".$start_date."',event_end_date='".$close_date."'  where id='".$event_id."'";
		}else{
	        $update		=	"UPDATE `events` set event_title='".$event_title."', title_arabic ='".$ar_title."', event_location='".$event_location."',location_arabic = '".$ar_location."', event_description='".$event_desc."' , desc_arabic='".$ar_desc."',test_drive='".$test_drive."',drive_arabic='".$ar_drive."',event_start_date='".$start_date."',event_end_date='".$close_date."' where id='".$event_id."'";
		}
	...
	function edit_provider()
	{
		...
		$slider_name1	=	$this->escape_string($_POST['slider_name1']);
		echo $update	=	"update providers SET `provider_image`='".$slider_name1."',`show`='".$slider_active."',`provider_name`='".$text."',`s_name`		=	'".$s_name."',
					`s_mob`		=	'".$s_mobile."',
					`s_email`		=	'".$s_email."',
					`s_address1`	=	'".$s_address1."',
					`s_address2`	=	'".$s_address2."',
	...
	function edit_banks(){
		...
		$reducing_rate		=	$this->escape_string($_POST['reducing_rate']);
		$link				=	$this->escape_string($_POST['link']);
		$arabic_link		=	$this->escape_string($_POST['arabic_link']);
		...
		move_uploaded_file($_FILES["slider"]["tmp_name"],$slider_path.$slider_name);
		$this->make_thumb('../'.$full_path,'../'.$thumb_path,150,$ext);
	 $insert		=	"UPDATE `finance` SET `provider`='".$provider."',`minimum_salary`='".$minimum_salary."',`down_payment`='".$down_payment."',`monthly_payment`='".$monthly_payment."',`flat_rate`='".$flat_rate."',`reducing_rate`='".$reducing_rate."',`image_name`='".$slider_name."', `thumb_path`='".$thumb_path."', `full_path`='".$full_path."', `link`='".$link."', `arabic_link`='".$arabic_link."' WHERE id='".$id."'";
		}else{
		$slider_name1	=	$this->escape_string($_POST['slider_name1']);
		$insert		=	"UPDATE `finance` SET `provider`='".$provider."',`minimum_salary`='".$minimum_salary."',`down_payment`='".$down_payment."',`monthly_payment`='".$monthly_payment."',`flat_rate`='".$flat_rate."',`reducing_rate`='".$reducing_rate."',`image_name`='".$slider_name1."', `link`='".$link."', `arabic_link`='".$arabic_link."' WHERE id='".$id."'";
		}
	...
	function check_already($value,$table,