...
<div id="page-container"<?php if ($page_classes)
    ...
    <div id="sidebar">
        ...
        <div class="sidebar-scroll">
            ...
            <div class="sidebar-content">
                ...
                <a href="index.php" class="sidebar-brand">
                    ...
                    <i class="gi gi-flash"></i><strong>Admin</strong>Panal
        ...
        <?php if ($url == 'header')
            { // if it is a header and not a link  ?>

                                <li class="sidebar-header">

            <?php if (isset($link['opt']) && $link['opt'])
                { // If the header has options set  ?>
        ...
        <?php }
            ...
            { // If it is a link  ?>
                                ...
                                <li<?php echo $li_active; ?>>
                                    ...
                                    <a href="<?php echo $url; ?>"<?php echo $link_class; ?>><?php if (isset($link['sub']) && $link['sub'])
                { // if the link has a submenu ?><i class="fa fa-angle-left sidebar-nav-indicator"></i><?php } echo $icon . $link['name']; ?></a>
                                        ...
                                        { ?><i class="fa fa-angle-left sidebar-nav-indicator"></i><?php } echo $sub_link['name']; ?></a>
...
<?php if ($template['header_content'] == 'horizontal-menu')
    { // Horizontal Menu Header Content  ?>
...
<!--                <form action="page_ready_search_results.php" method="post" class="navbar-form-custom" role="search">
                ...
                <ul class="nav navbar-nav-custom pull-right">
                    ...
                    <li class="dropdown">
                        ...
                        <a href="logout.php"  class="" data-toggle="">
Logout
...
<!--                        <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                            ...
                            <li class="dropdown-header text-center"><a > </a></li>
