...
<?php include 'inc/page_head.php';
	$results	=	$obj->get_single_result('genre','genre_id',$_GET['id']);
 ?>
        ...
        <div class="col-md-9">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    <h2><strong>Edit Genre Page</strong></h2>
                </div>
                ...
                <input type="hidden" name="genre_id" value="<?php echo $results['genre_id']; ?>">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input type="text" id="genre_name" name="genre_name" class="form-control" placeholder="Type Name.." value="<?php if(isset($results['genre_name'])){echo $results['genre_name'];} ?>">
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-md-6">
							<?php if(isset($results['genre_active']) && $results['genre_active']=='yes'){
								$yes	= 'selected'; 
							}else{
								$yes	= ''; 
