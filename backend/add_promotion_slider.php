...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top">
		...
		<li><a href="all_slider.php">Manage Sliders</a></li>
                <li><a href="promotion_slider.php">Promotion slider</a></li>
                <li><a href="add_promotion_slider.php">Add Promotion slider</a></li>
    </ul>
    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <div class="block">
				...
				<input type="hidden" name="action" value="add_promotion_slide">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input type="file" id="sliderp" name="sliderp">
								</div>
                            </div>
                        </div>
                      </fieldset>
