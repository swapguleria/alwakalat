...
<?php include 'inc/page_head.php';
	...
	$results	=	$obj->get_single_result('day','day_id',$_GET['id']);
        ...
        <div class="col-md-9">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    ...
                    <h2><strong>Edit Days Page</strong></h2>
                ...
                <input type="hidden" name="day_id" value="<?php echo $results['day_id']; ?>">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="day_name" name="day_name" class="form-control" placeholder="Type Name.." value="<?php if(isset($results['day_name'])){echo $results['day_name'];} ?>">
                      ...
                      <div class="form-group">
							...
							<?php if(isset($results['day_active']) && $results['day_active']=='yes'){
