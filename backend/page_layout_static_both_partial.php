<?php include 'inc/config.php'; $template['sidebar'] = 'sidebar-partial sidebar-alt-partial sidebar-no-animations' ?>
...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-show_big_thumbnails"></i>Both Sidebars Partial<br><small>You could go crazy and have two partial sidebars which open on hover!</small>
            </h1>
        </div>
    </div>
