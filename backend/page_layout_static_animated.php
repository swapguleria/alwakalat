<?php include 'inc/config.php'; $template['sidebar'] = 'sidebar-partial sidebar-visible-lg' ?>
<?php include 'inc/template_start.php'; ?>
<?php include 'inc/page_head.php'; ?>

<!-- Page content -->
<div id="page-content">
    <!-- Animated Sidebar Transitions Header -->
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-show_big_thumbnails"></i>Animated Sidebar Transitions<br><small>On small screens animations are enabled by default but you can easily have them in large screens, too! Try toggling the sidebars (top left and right header buttons)!</small>
            </h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li>Page Layouts</li>
        <li><a href="">Animated Sidebar Transitions</a></li>
    </ul>
    <!-- END Animated Sidebar Transitions Header -->
