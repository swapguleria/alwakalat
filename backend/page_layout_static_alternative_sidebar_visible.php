<?php include 'inc/config.php'; $template['sidebar'] = 'sidebar-alt-visible-lg sidebar-no-animations'; ?>
<?php include 'inc/template_start.php'; ?>
<?php include 'inc/page_head.php'; ?>

<!-- Page content -->
<div id="page-content">
    <!-- Visible Alternative Sidebar Header -->
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-show_big_thumbnails"></i>Visible Alternative Sidebar<br><small>Toggles completely from visible to hidden and back. Can be set as the default on all layouts! (> 991px)</small>
            </h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li>Page Layouts</li>
        <li><a href="">Visible Alternative Sidebar</a></li>
    </ul>
    <!-- END Visible Alternative Sidebar Header -->
