...
$results	=	$obj->get_single_result('social_links','id',$_GET['id']);
...
<div id="page-content">
    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <div class="block">
              ...
              <input type="hidden" name="slider_name1" value="<?php echo $results['name']; ?>">
    ...
    padding: 5px;"><?php echo $_SESSION['success']; unset($_SESSION['success']);?></div>
					<?php } ?>
						...
						<div class="form-group">                           
						<label class="col-md-3 control-label" for="slider_active">Address<span class="text-danger"></span></label>                            <div class="col-md-6">
						<input type="text" class="form-control" name="text" value="<?php if(isset($results['address'])) {echo $results['address'];} ?>">									                            
						</div>                        
						</div>												
						   <div class="form-group">
