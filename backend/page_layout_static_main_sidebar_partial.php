<?php include 'inc/config.php'; $template['sidebar'] = 'sidebar-partial sidebar-no-animations'; ?>
<?php include 'inc/template_start.php'; ?>
<?php include 'inc/page_head.php'; ?>

<!-- Page content -->
<div id="page-content">
    <!-- Partial Main Sidebar Header -->
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-show_big_thumbnails"></i>Partial Main Sidebar<br><small>Opens on hover, can be set as the default on all layouts! (> 991px)</small>
            </h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li>Page Layouts</li>
        <li><a href="">Partial Main Sidebar</a></li>
    </ul>
    <!-- END Partial Main Sidebar Header -->
