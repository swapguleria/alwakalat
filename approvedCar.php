                ...
                <div id="description">
                    <div class="description">
                        <div class="description_header clearfix">
                            ...
                            <button class="btn btn default add_to pull-right btn_click" data-get="<?php echo $_REQUEST['id'] ?>" id="<?php echo $_REQUEST['id'] ?>">Add To Wish List</button>
                        </div>
                    ...
                    <div id="messagess" class="contact">
                        <div class="contact_header clearfix text-center">
                            <h3>Contact Us</h3>
                            <p>Contact Information of Car Dealer</p>
                        </div>
...
//$headers .= 'Cc: myboss@example.com' . "\r\n";
                        ...
                        <form role="form" method="post" action="<?php echo $_SERVER['SELF'] ?>#messagess" class="text-center">
                            <div class="form-group">
                                <input type="text" placeholder="Your Name" name="username" required="required" class="form-control">
                                <input type="email" required="required" name="email" placeholder="Email Address" class="form-control">
                                <input type="tel" pattern="[0-9]{10,10}" required="required" placeholder="Phone Number" name="phone" class="form-control">
                                <textarea type="text" placeholder="Message" required="required" name="message" class="form-message"></textarea>
                                <input type="submit" name="send" class="btn btn-default form_submit" value="Send Message"/>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="related col-sm-12">
                    <div class="related_header">
                        <h3>Related <span>Listings</span></h3>
                    </div>
                    <?php
