...
<div class="col-sm-12 left-contact" id="feedbackform" style="display:none;width:400px;">
    <div class="left-inner">
        <h1>Owner Feedback</h1>
        <form action="" method="POST" id="feedback" novalidate="novalidate">
            <input type="text" name="name" placeholder="Full Name *">
            <input type="text" name="email" placeholder="Email*">
            <input type="text" name="phone" placeholder="Phone Number*">
            <textarea name="feeds"  placeholder="Feedback*"></textarea>
            <div class="sumbit-offer-button">
                ...
                <div class="brands-prices-bottom">
                    <table width="100%" border="1px">
                        ...
                        <tr>
                            ...
                            <td><h4><?php echo $car_data['engineSize']; ?></h4></td>
                            <td><h4><?php echo $car_data['h_power']; ?>HP</h4></td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 slider-main brand_right">
                ...
                <div class="offer-main-new">
                    ...
                    <div class="offer-image-main-two offer-image-main-two-div">
                        ...
                        <div class="alwalkat-button">
                            <a href="#feedbackform" class="fancybox">Owner  Feedback</a>
                        </div>
...
<?php $reviews = $get->get_review('','',$_GET['id']);
if (@$reviews)
    { ?>   <div class="offer-image-main-two offer-image-main-two-div">
                        <div class="offer-image">
                            <a href="#"><img src="images/offer-icon2.png" alt=""></a>
...
<?php } ?>
                    ...
                    <div class="complete-model">
                        <div class="completive-model-text">
                            ...
                            <?php
                            $query = "select * from car_data where price <=" . $car_data['price'] . " ORDER BY RAND() limit 3";
                            $run_query = mysql_query($query) or die(mysql_error());
                            while ($row = mysql_fetch_array($run_query))
                                {
                                ?>
                                <div class="model-image">
                                    <a href="car-brands.php?id=<?php echo $row['id']; ?>"><img src="<?php echo $row['full_path']; ?>" alt=""></a>
                                </div>

                                <div class="model-bottom-text">
                                    <h2><?php echo $get->get_single_field('maker', 'name', 'id', $row['maker_id']); ?> <?php echo $get->get_single_field('model', 'model_name', 'model_id', $row['model']); ?><span><a href="#">Price QAR <?php echo number_format($row['price']); ?></a></span></h2>
