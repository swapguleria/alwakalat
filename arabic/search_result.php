...
?>
<div class="searches">
    <div class="container inner-container"><h1><?php echo $get->get_single_field('maker', 'name', 'id', $_POST['maker']) ?> سيارات بأسعار أقل من ريال قطري <?php echo number_format(clean($_POST['price'])); ?></h1> 
