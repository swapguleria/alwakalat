          ...
          <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
            ...
            <div class="panel panel-default">
              <div class="panel-heading" role="tab" id="headingOne">
				...
				<a role="button" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $i;?>" aria-expanded="false" aria-controls="<?php echo $i;?>"><?php echo $value['question_arabic'];?></a> </h4>
              </div>
              <div id="<?php echo $i;?>" class="panel-collapse collapse <?php if($i==1){ echo "in";}?>" role="tabpanel" aria-labelledby="headingOne">
                <div class="panel-body"> <?php echo $value['answer_arabic'];?></div>
              </div>
            </div>
           <?php } ?>
          </div>
...
الرجاء إدخال معرف بريد إلكتروني صحيح ...</p>";
                       }
		  ...
		  <form class="clearfix" id="advertise" action="" method="POST">
            <span>
            <input type="text" name="firstname" value="<?php if(isset($_POST['firstname'])) echo $_POST['firstname'];?>" placeholder="الاسم الأول ">
            </span> <span>
            <input type="text" name="lastname" value="<?php if(isset($_POST['lastname'])) echo $_POST['lastname'];?>" placeholder="لقب">
            </span> <span>
            <input type="email" name="email" value="<?php if(isset($_POST['email'])) echo $_POST['email'];?>" placeholder="عنوان البريد الإلكتروني ">
            </span> <span>
            <input type="text"  name="phone" value="<?php if(isset($_POST['phone'])) echo $_POST['phone'];?>" placeholder="رقم الهاتف">
            </span> <span>
            <textarea name="content"><?php if(isset($_POST['content'])) echo $_POST['content'];?></textarea>
             <input type="submit" value="أرسل رسالة" name="submit">
           </span>
