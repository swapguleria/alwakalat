        ...
        <div class="row">
            <div class="col-sm-8 left-contact">
                <div class="left-inner">
                    <h1><?php echo $results['page_title_arabic']; ?></h1>
...
الرجاء إدخال معرف بريد إلكتروني صحيح ...</p>";
                        ...
                        if ($retval == true)
                            {
                            echo "<p style='color: green; font-weight: bold; font-size: 15px;'>أرسلت الرسالة بنجاح </p>";
                            }
                        else
                            {
                            echo "<p style='color:Red; font-weight: bold; font-size: 15px;'>تعذر إرسال الرسالة </p>";
                            }
                       }
                        }
                    ?>
