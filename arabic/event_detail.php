        ...
        <div class="row">
            <div class="span12">
                <div id="owl-demoEvent" class="owl-carousel">
                    <div class="item"><a href="#"><img src="../<?php echo $event_data['full_path']; ?>" alt="" title=""></a></div>
<?php foreach ($slider_event as $event) { ?>
                        <div class="item"><a href="#"><img src="../<?php echo $event['full_path']; ?>" alt="" title=""></a></div>
    ...
    <div class="event-main">
        <div class="container">
            <div class="event-details">
                ...
                <p> <?php echo $event_data['desc_arabic']; ?> </p>
            </div>
        </div>
    </div>
</div>
...
<?php echo $event_data['title_arabic']; ?>
                    </div>
...
<?php if ($event_data['test_drive'] != '') { ?><h3>اختبار القيادة</h3><?php echo $event_data['drive_arabic'];
} ?></div>
            </div>
        </div>
