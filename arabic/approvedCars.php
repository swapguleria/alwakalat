            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="process_head text-center">
                        <h1>السيارات المعتمدة من الوكالات</h1> 
            ...
            <div class="row">
                ...
                <div class="process_one text-center">
                    <div class="process_inner text-center">
                        <img src="<?php echo $main_url; ?>/images/arabic_approved.jpg"/>
                        <!--                            <h3>السيارات المعتمدة</h3>
                                                    <h5>سيضاف المحتوى لاحقا</h5>-->
                    </div>    
                </div>
                <!--</div>-->
            </div>
                                ...
                                <div class="budget_inner">
                                    <div class="budget_cetagory">
                                        <form action="carSearch.php" method="get" >
                                            <input checked="checked" type="radio" name="budget" value="0"><label>إبحث بالسعر</label>
                                            <input type="radio" name="budget" value="1"><label>ابحث عن طريق الصنع والفئة</label>
...
<!--                                            <input type="range" name="price" min="<?php echo $min['mi']; ?>" max="<?php echo $value = $max['mi'] + 1; ?>" value="<?php echo $value = $max['mi'] + 1; ?>" onchange="rangePrimary.value = 'QAR ' + addCommas(value)">-->
                                    ...
                                    <div class="budget_btn">
                                        <button class="btb btn-default btn_srch">بحث</button>
                                    </div>
                                    </form>
                                    <div class="budget_btn text-center">
                                        ...
                                        <button id="advancedsearch" class="btb btn-default btn_ad_srch">بحث تفصيلي</button>
                                    </div>        
                                </div>
                                ...
                                <div id="find_cars" class="find_cars process_find_cars " style="display: none">
                                                    ...
                                                    <div class="find_car_option">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select id="filter_price" name="price" >
                                                                ...
                                                                <option value="1">أقل من QR 65,000</option>
                                                                <option value="2">أقل من QR 100,000</option>
                                                                <option value="3">أقل من QR 125,000</option>	
                                                                <option value="4">أقل من QR 150,000</option>
                                                                <option value="5">أقل من QR 200,000</option>
                                                                <option value="6">أقل من QR 250,000</option>
                                                                <option value="7">أقل من QR 350,000</option>	
                                                                <option value="8">أقل من QR 500,000</option>
                                                                <option value="9">اكثر من QR 500,000</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            <!--<label>Select Price</label>-->
                                                            <select id="filter_milage" name="milage" >
                                                                ...
                                                                <option value="60000">أقل من 60,000</option></select>
                                                        </div>
                                                        <div class="form-group">
                                                            <!--<label>Select Price</label>-->
                                    ...
                                    <div class="budget_btn text-center">
                                        <!--<a href="advanceSearch.php"><button class="btb btn-default btn_ad_srch">Advanced Search</button></a>-->
                                        <button id="normalsearch" class="btb btn-default btn_ad_srch">اخفاء البحث التفصيلي</button>
                                    </div>
                                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    <div class="compare">
                        <a href="approvedcomparison.php"><button class="btn btn-default compare_btn">مقارنة السيارات المعتمدة</button></a>
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <div id="approved_cars">  
        <div class="searches container">
            <div class="container inner-container">
                <h2>عرض جميع السيارات المعتمدة</h2>
                                    ...
                                    <div class="approved_slider clearfix">
                                        <div class="col-sm-8">
                                            <div class="approved_slider_img">
                                                ...
                                                if ($val['banner_image'])
                                                    {
                                                    ?>
                                                    <img src="http://alwakalat.com/timthumb/timthumb.php?h=590&src=http://alwakalat.com/approvedCars/wdir/uploads/<?php echo $val['banner_image']; ?>" >
                                        ...
                                        <div class="col-sm-4">
                                            <div class="approved_slider_left text-left">
                                                ...
                                                <a  href="/approvedCar.php?id=<?php echo $val['id']; ?>" class = "btn btn-default slider_btn">اقرأ اكثر</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
