...
if (isset($_GET['id']) && $_GET['id'] != "") {
    $car_id = $_GET['id'];
    $_SESSION= session_unset($_SESSION['id']);
    $_SESSION['id'] = $car_id;

    $cars = $get->get_all_data_active('car_data', 'id', 'asc', 'maker_id', $_SESSION['id']);
   //print_r($cars);
   //die();
    ...
    <div class="container inner-container">
        ...
        <div class="filter">
            <form id="filterform" action=" " type="post">
                ...
                <input type="hidden" name="maker_id" id="maker"  value="<?= $_SESSION['id']; ?>">
        ...
        foreach ($cars_data as $filtered_cars) {
            ?>
                        <div class="search-main-product">
                            <div class=""> <a href="car-brands.php?id=<?php echo $filtered_cars['id']; ?>"><img src="http://alwakalat.com/timthumb/timthumb.php?w=200&h=121&src=http://alwakalat.com/<?= $filtered_cars['full_path']; ?>" class="" style="width: 200px;height:121px;"><br /></a> </div>
