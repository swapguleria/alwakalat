            ...
            <div id="primary" class="col-sm-9">
                <div class="review-content">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="car_reviews.php?id=<?php echo $id; ?>#disqus">مراجعة</a></li>
                        <li><a data-toggle="tab" href="#menu2">الصور</a></li>
                        <li class="active" ><a  data-toggle="tab" href="#menu3">فيديو</a></li> 
                    </ul>
...
//                                        $get->get_all_data_active('car_slider', 'id', 'asc','car_id', $id);
//echo '<pre>';                         
//print_r($slider_car);
                        ...
                        <div id="menu3" class="tab-pane fade in active">
                            ...
                            if (@$model['video'])
                                ...
                                {
                                ?>
                                <a href="#"><img src="../images/no_video.jpg" title="<?php echo date("Y", strtotime($model['date'])); ?> <?php echo $name; ?> Review Quick Drive" alt="<?php echo date("Y", strtotime($model['date'])); ?> <?php echo $name; ?> Review Quick Drive"></a><?php } ?>
                        </div>
                    </div>
                    <div class="review-description">
                        ...
                        <div class="social-likes">
                            <div class="fb-share-button" data-href="http://alwakalat.com/car_reviews.php?id=<?php echo $id; ?>" data-layout="button_count" data-mobile-iframe="true"></div>

                            <a class="twitter-icon" href="https://twitter.com/share?url=http://alwakalat.com/car_reviews.php?id=<?php echo $id; ?>" target="_blank">
                                <img src="https://simplesharebuttons.com/images/somacro/twitter.png" alt="Twitter" />
                            </a>
                            <div class="g-plus" data-action="share" data-annotation="none" data-height="24" data-href="car_reviews.php?id=<?php echo $id; ?>"></div>
                            <a class="comments" href="car_reviews.php?id=<?php echo $id; ?>#disqus" title="Comments"><img src="../images/comment-icon.png" title="Comments" alt="Comments"></a>
                        </div><!--social-likes-->
                        <p><?php echo $model['description_ar']; ?></p>
                        <?php
                        $slider_car = $get->get_all_data_active('car_slider', 'id', 'asc', 'car_id', $id);
                        ?><div class="review-artcles">
                            <div class="article-content">	
                                ...
                                <p><?php echo $model['description2_ar']; ?></p>
                            </div>
                        </div><!--review-articles-->
                ...
                <div class="review-siebar">
                    ...
                    if (@$reviews)
                        ...
                        foreach ($reviews as $review)
                            ...
                            <div class="review-section"><div class="latest-review">
...
<!--                                        <div class="comment-box-num">
                                    ...
                                    ?><a href="car_reviews.php?id=<?php echo $review['cat_id']; ?>"><img src="../<?php echo $car_details['full_path']; ?>" title="<?= $name_car ?>" alt="<?= $name_car ?>"></a>
                                </div><!--latest-review-->
                                <div class="about-review">
                                    <h6><?= $name_car ?></h6>
                                </div>   </div><!--about-review-->
                        ...
                        <div class="alert alert-info">
                            <strong>آسف !</strong> لم يتم تقديم تعليقات.
                        </div>
                    <?php } ?>   <!--review-section-->
                </div><!--review-siebar-->
        ...
        <?php $slider_car = $get->get_all_data_active('car_slider', 'id', 'asc', 'car_id', $view["id"]); ?> 
                                ...
                                <div class="car-description">
                                    <ol>
                                        <li>
        <?= $count ?>. <?= $name_car ?><span>السعر: QR<?php echo $car_details['price']; ?></span>
                                        </li>
                                    </ol>
                                </div><!--car-description-->
                            </div><!--rank-container-->
