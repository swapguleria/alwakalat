                            ...
                            <div class="latest-review load-item" style="display:none" >
                                ...
                                <div class="row">
                                    <div class="col-sm-4 review-car-img">
                                        <a href="car_reviews.php?id=<?php echo $review['cat_id']; ?>"><img src="../<?php echo $car_details['full_path']; ?>" title="<?= $name_car ?>" alt="<?= $name_car ?>"></a></div><!--col-sm-4-->

                                    <div class="col-sm-8 review-description">
                                        <div class="about-review">
                                            <h6><b><?= $name_car ?></b></h6>
                                            <h5><a href="car_reviews.php?id=<?php echo $review['cat_id']; ?>"><?php echo $review['description_ar']; ?></a></h5>
                                        </div><!--about-review-->
                                    </div><!--col-sm-8-->
                                </div><!--row-->
                            </div><!--latest-review-->
                        ...
                        foreach ($views as $view)
                            ...
                            ?><div class="rank-container">
                                ...
                                <div class="car-descriptionone">
                                    <ol>
                                        <li>
                                            <?= $count ?>.<?= $name_car ?><span>السعر:  $<?php echo $car_details['price']; ?></span>
                                        </li>
                                    </ol>
                                </div><!--car-description-->
                            </div><!--rank-container-->
